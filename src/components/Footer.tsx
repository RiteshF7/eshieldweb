    ...
    return (
        <div className="relative">
            <Container>
                ...
                >
                    <CenteredContent/>
                    {/* Separate component for the commented code */}
                    {/*<AdditionalContent/>*/}
                </div>
...
const CenteredContent = () => (
    <div className="lg:col-span-2 mx-auto">
        ...
        <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
            Our platform is built on cutting-edge technology, ensuring reliable performance and maximum
            security. We maintain the highest standards of data protection and privacy compliance.
        </div>
    </div>
);
